...
<div class="tabs">
  <ul class="tabmenu hidden">
    ...
    <center>
	<div id="bsap_1245277" class="bsarocks bsap_4218e960c1b0656c48fc50d2e5ee9dd5"></div>
...
<?php wp_nonce_field('update-options'); global $themename, $shortname, $swiz_options;?> 
<?php
$options_list='';
...
<label><input type="radio" name="<?php echo $value['id']; ?>" value="<?php echo $option?>" <?php if ( get_settings( $value['id'] ) == $option){ echo 'checked';} ?>/><?php echo $option?></label>
<?php } ?>
</div>
