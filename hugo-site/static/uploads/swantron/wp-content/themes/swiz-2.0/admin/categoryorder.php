<?php
 ...
 function swiz_mycategoryorder_getTarget() {
	return "admin.php";
}

function swiz_mycategoryorder()
{wp_enqueue_script('jquery');
	...
	{  
		...
		update_option( 'swiz_cat_inc', $catString );
...
<div id="cat-order" >
    ...
    <p>Select the categories you want to include in your nav menu, click the order categories button below to save.</p>
	<ul id="orderCats">
    
		<?php 
			$inc=explode(',',get_option('swiz_cat_inc'));
...
<script language="JavaScript">
 ...
 // <![CDATA[
	...
	function orderCats() {
		...
		location.href = '<?php echo swiz_mycategoryorder_getTarget(); ?>?page=swiz-options&mode=act_OrderCategories&parentID=<?php echo $parentID; ?>&idString='+idList+'&catString='+catList+'#Header-Options';
	}
	function goEdit ()

	{
		if(jQuery("#cats").val() != "")
			location.href="<?php echo swiz_mycategoryorder_getTarget(); ?>?page=swiz-options&parentID="+jQuery("#cats").val();
	}
