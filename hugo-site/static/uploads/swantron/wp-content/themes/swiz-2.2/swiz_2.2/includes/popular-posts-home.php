...
?>
		<li>
			<?php if($custom_field) { ?>
				<a title="<?php echo $post_title; ?>" href="<?php echo $guid; ?>"><img src="<?php echo U_URL.'/swiz_custom';?>/timthumb.php?src=<?php echo $custom_field; ?>&amp;h=90&amp;w=220&amp;zc=1&amp;" width="220" height="90" alt="<?php echo $post_title; ?>" class="pop-thumb" /></a>            
            <?php } ?>                
