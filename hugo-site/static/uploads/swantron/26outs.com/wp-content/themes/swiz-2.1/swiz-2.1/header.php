...
<?php if(!$temp=get_option('swiz_favicon'))$temp=get_bloginfo('template_url').'/images/favicon.ico';?>
<link rel="shortcut icon" href="<?php echo $temp;?>"  />

<meta http-equiv="Content-Type" content="<?php bloginfo('html_type'); ?>; charset=<?php bloginfo('charset'); ?>" />
<link rel="stylesheet" type="text/css" href="<?php bloginfo('stylesheet_url'); ?>" media="screen" />  
<link rel="stylesheet" type="text/css" href="<?php echo U_URL.'/swiz_custom';?>/custom-style.css" media="screen" />
...
<?php if ($header_scripts=get_option('swiz_header_scripts')) { echo stripslashes($header_scripts);}?> 
</head>
<body>
 
<?php navigation(get_option('swiz_nav1'),1);?>
...
<div id="header-container">
	<div id="header" class="grid_960 clearfix">
        ...
        <?php if(get_option('swiz_logo')): ?>
        <div id="logo" class="alignleft">
			<a href="<?php bloginfo('url'); ?>" title="<?php bloginfo('description'); ?>">
            <img src="<?php echo get_option('swiz_logo')?>" alt="<?php bloginfo('name'); ?>"  /></a>
        </div><!--/logo-->
        ...
        <?php if ( get_option('swiz_header_ad_enable') == "true" && $headerad=get_option('swiz_header_adcode') ){ ?>
...
<?php navigation(get_option('swiz_nav2'),2); ?>


<?php //Inserts adcode below navigation
	if (get_option('swiz_nav_adsense_enable') == "true" && $adcode=get_option('swiz_nav_adcode')){ ?>
