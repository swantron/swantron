...
Here we go. As I [mentioned a few days ago](https://swantron.com/solar-panel-led-set-up/), I'm horsing around with analog input to my Arduino, in the form of input via a solar cell. For the win. It turns out, that I'm getting far better with my casual electronics experimentation...I will chalk this one up as a win...My basic set-up is this...Radio Shack solar cell, breadboard, florescent light source, Arduino, and a notebook.

### Step 1: Gauge light source via multimeter
![test](/uploads/2010/06/solar-test.jpg "solar-test")
...
![setup](/uploads/2010/06/breadboard-setup.jpg "breadboard-setup")
...
![enhance](/uploads/2010/06/arduino-wired.jpg "arduino-wired")
...
![solar](/uploads/2010/06/solar-arduino1.jpg "solar-arduino1")
...
![cigs](/uploads/2010/06/experiment-setup.jpg "experiment-setup")
...
![for the goddamned win](/uploads/2010/06/arduino-solar-two.jpg "arduino-solar-two")

Most definitely for the win...with the experimental noise, that could be considered effectively zero.
 For the win. In summation, I have read in analog, as intended. Lessons learned? Pretty straight forward I suppose. My cheap-o solar cell is rated for a max of 6V, which I was far under. If I was to use this setup with a stronger light source, I would need to take this into consideration. I didn't perform any data transformation, as I was not concerned with 'actual voltage input values' in this case...merely relative. Most importantly, I was able to knock out the task I had set out to do. Hopefully, I can ride my EE high and get cranking on something awesome, like a netbook robot. With some lasers.